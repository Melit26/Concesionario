...
class CocheResourceIT {
    ...
    private static final String DEFAULT_TIPO_COCHE = "AAAAAAAAAA";
    private static final String UPDATED_TIPO_COCHE = "BBBBBBBBBB";
    ...
    void createCoche() throws Exception {
        ...
        assertThat(testCoche.getKilometraje()).isEqualTo(DEFAULT_KILOMETRAJE);
        assertThat(testCoche.getColor()).isEqualTo(DEFAULT_COLOR);
        assertThat(testCoche.getTipoCoche()).isEqualTo(DEFAULT_TIPO_COCHE);
        assertThat(testCoche.getEstado()).isEqualTo(DEFAULT_ESTADO);
    ...
    @Test
    @Transactional
    void checkKilometrajeIsRequired() throws Exception {
        int databaseSizeBeforeTest = cocheRepository.findAll().size();
        // set the field null
    ...
    @Test
    @Transactional
    void checkTipoCocheIsRequired() throws Exception {
        int databaseSizeBeforeTest = cocheRepository.findAll().size();
        // set the field null
        coche.setTipoCoche(null);
    ...
    void getAllCoches() throws Exception {
        ...
        restCocheMockMvc
            ...
            .andExpect(jsonPath("$.[*].tipoCoche").value(hasItem(DEFAULT_TIPO_COCHE)))
    ...
    void getCoche() throws Exception {
        ...
        restCocheMockMvc
            ...
            .andExpect(jsonPath("$.tipoCoche").value(DEFAULT_TIPO_COCHE))
    ...
    void putNewCoche() throws Exception {
        ...
        assertThat(testCoche.getKilometraje()).isEqualTo(UPDATED_KILOMETRAJE);
        assertThat(testCoche.getColor()).isEqualTo(UPDATED_COLOR);
        assertThat(testCoche.getTipoCoche()).isEqualTo(UPDATED_TIPO_COCHE);
        assertThat(testCoche.getEstado()).isEqualTo(UPDATED_ESTADO);
    ...
    void partialUpdateCocheWithPatch() throws Exception {
        ...
        partialUpdatedCoche.modelo(UPDATED_MODELO).estado(UPDATED_ESTADO).precio(UPDATED_PRECIO);
